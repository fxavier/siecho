...
class Inquerito(models.Model):
    ...
    servico_prevencao_recebeu = models.ForeignKey(ServicoPrevencao, on_delete=models.CASCADE)
    servico_cuidado_tratamento_recebeu = models.ForeignKey(ServicoCuidadosTratamento, on_delete=models.CASCADE)
